...
void backToMailList(GtkWidget *widget, GdkEventButton *event, gpointer data) {
...
GtkWidget *mailPage(GtkWidget *vbox, const char *title, const char *message, const char *sender, const char *time) {
  ...
  gtk_box_pack_start(GTK_BOX(box), senderRow, FALSE, FALSE, 0);
  gtk_box_pack_start(GTK_BOX(box), messageLabel, FALSE, FALSE, 10);
